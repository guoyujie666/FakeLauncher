...
[![Kotlin Version](https://img.shields.io/badge/Kotlin-2.2.0-blueviolet?logo=kotlin)](https://kotlinlang.org)
...
**FakeLauncher** 是一款运行在 Wear OS 智能手表上的创新应用。它的核心功能是呈现一个极度精简、专注于基础信息的用户界面（如时间、日期、步数），使其在外观和即时交互上接近一款轻智能手表。
...
- **可控应用抽屉**：通过上滑手势呼出，仅显示假的应用，隐藏复杂的智能功能 ~~（您的游戏）~~ 。
...
### 使用教程
进入悬浮窗后，在5秒内点击10次主界面大时间后长按大时间即可退出。
伪关机后，长按屏幕10秒以上开机。
